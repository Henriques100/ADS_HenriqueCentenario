...
public class OutroNome {
   public static void main(String[] args)
   {
	   ...
	   //System.out.println("Abra de sésamo!!!");
	   // 2 - Altere seu programa para imprimir duas linhas de texto usando duas linhas de código System.out.
	   System.out.println("Jogador capivara é ruim!!!");
	   System.out.println("Precisa treinar mais, para melhor provar suas habilidades");
       ...
       System.out.println("João comeu a maça, \n"
